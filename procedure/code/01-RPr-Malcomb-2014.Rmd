...
Compare drought and flood impacts. 
``` {r compare-drought-flood}
grt_risk <- flood_r - drought_r
tmap_mode("plot")
tm_shape(grt_risk) + tm_raster()
#grt_r_map <- tm_raster(grt_risk, title = "Comparing Flood and Drought Risk Geographies")
#qtm(grt_r_map)
