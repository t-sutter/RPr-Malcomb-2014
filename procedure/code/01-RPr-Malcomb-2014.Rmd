...
tmap_mode("plot")
tm_shape(zonal) + 
  tm_polygons(col="vulnerability", breaks=c(35, 45, 55, 65), title="Mean Climate Vulnerability by TA", palette="YlOrRd", lwd=0.1, border.col="white") +
tm_layout(main.title = "Malawi Climate Vulnerability",main.title.size = 1.2, main.title.position = "center", frame = FALSE, legend.width=3, legend.text.size = .7, legend.title.size = 1, asp=0.9, )
